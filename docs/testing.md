...
| Rede (QEMU) | `tools/test-qemu --scenario net` | `run-qemu --net` (slirp): ARP request montado pelo cliente sai pelo `netdev` (ring 3) e o ARP reply do gateway 10.0.2.2 volta com o MAC esperado |
